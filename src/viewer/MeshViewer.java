...
public class MeshViewer extends PApplet {
	...
	public void setup() {
		...
		public void keyPressed(){
			  switch(key) {
			    case('p'):case('P'): this.computeParameterization(0); break;
			    case('r'):case('R'): this.renderType=(this.renderType+1)%this.renderModes; break;
			    case('l'):case('L'): this.changeLALibrary(); break;
			  }
