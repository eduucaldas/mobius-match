...
//    private HashMap<Vertex<Point_3>, Double> uStar;
    ...
    private DoubleMatrix1D computeU() {
        ...
        System.out.println("el: " + count + ", space: " + p.vertices.size()*p.vertices.size());
        System.out.println((double)A.cardinality()/A.size());
        System.out.println((double)b.cardinality()/b.size());
        A.trimToSize();
        b.trimToSize();
